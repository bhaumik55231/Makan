...
public class addResidentDAO {
	...
	public void update_rental_status1(rentalRequestVO rentalRequestVO) 
	{
		Session session = null;
		try
		{
		...
		Query q=session.createQuery("update rentalRequestVO set status='approved' where rental_request_id='"+rentalRequestVO.getRental_request_id()+"'");
		int result = q.executeUpdate();
